...
namespace ServerBooks.App.Controllers.ExportExcel
{
    ...
    public class ExcelExportController  : ControllerBase
    {
        ...
        [HttpGet]
        public IActionResult GetManagementIndicators()
        {
            var download = _repository.ExportExcelAdmin();
            return File(download, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", $"ManagementIndicators.xlsx");
        }
